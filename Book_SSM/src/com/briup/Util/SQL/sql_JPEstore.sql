...
create table d_order(
	...
	orderline_id number references d_orderline(id)
);
----书的种类表--------
...
insert into d_price_rank values(0,0,99);
insert into d_price_rank values(1,100,199);
insert into d_price_rank values(2,200,299);
insert into d_price_rank values(3,300,399);
insert into d_price_rank values(4,400,499);
insert into d_price_rank values(5,500,599);
insert into d_price_rank values(6,600,699);
insert into d_price_rank values(7,700,799);
insert into d_price_rank values(8,800,1000);
